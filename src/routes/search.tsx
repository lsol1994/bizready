    ...
    <div class="flex h-screen overflow-hidden">
      <aside class="w-64 gradient-bg flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
          ...
          <a href="/dashboard/search"    class="sidebar-item active flex items-center gap-3 px-3 py-2.5 rounded-lg text-white text-sm"><i class="fas fa-search w-4 text-center"></i><span>지식 검색</span></a>
